...
router.register(r'proxy-settings', ProxySettingsViewSet, basename='proxysettings')
router.register(r'hls-output-settings', HlsOutputSettingsViewSet, basename='hlsoutputsettings')
urlpatterns = [
