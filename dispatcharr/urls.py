...
urlpatterns = [
    ...
    # XC catch-up (timeshift). Param naming preserved from the legacy iPlayTV URL contract:
    # the "duration" slot is actually the provider's stream_id (see apps/timeshift/views).
    path(
