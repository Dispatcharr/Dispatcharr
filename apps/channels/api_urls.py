...
from .api_views import (
    ...
    LogoViewSet,
    BannerViewSet,
    BulkDeleteBannersAPIView,
    CleanupUnusedBannersAPIView,
...
urlpatterns = [
    ...
    path('banners/bulk-delete/', BulkDeleteBannersAPIView.as_view(), name='bulk_delete_banners'),
    path('banners/cleanup/', CleanupUnusedBannersAPIView.as_view(), name='cleanup_unused_banners'),
