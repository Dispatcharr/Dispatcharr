...
class EPGSource(models.Model):
    ...
    api_key = models.CharField(max_length=255, blank=True, null=True)  # For Schedules Direct (password)
    username = models.CharField(max_length=255, blank=True, null=True)  # For Schedules Direct username
...
class EPGData(models.Model):
    ...
    logo_url = models.URLField(blank=True, null=True, help_text="Logo URL from Schedules Direct or other EPG source")
