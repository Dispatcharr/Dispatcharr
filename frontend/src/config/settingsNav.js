...
const MediaLibrarySettingsForm = lazy(() => import('../components/forms/settings/MediaLibrarySettingsForm.jsx'));
...
export const SETTINGS_GROUPS = [
  ...
  },
  {
    ...
    adminOnly: true,
    sections: [
      { id: 'media-library-settings', label: 'Media Library', icon: LibraryBig, Component: MediaLibrarySettingsForm },
    ],
  },
  {
    id: 'dvr',
