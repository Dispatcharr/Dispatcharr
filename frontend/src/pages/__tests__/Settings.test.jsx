...
describe('SettingsPage', () => {
  ...
  describe('regular user', () => {
    ...
    it('does not expose Media Library settings via a direct hash', () => {
      renderWithRouter(<SettingsPage />, {
        initialEntries: ['/settings#media-library-settings'],
      });
      expect(screen.getByText('Select a setting from the sidebar')).toBeInTheDocument();
    });
  });
  ...
  describe('admin user', () => {
    ...
    it('renders Media Library settings via hash', async () => {
      renderWithRouter(<SettingsPage />, {
        initialEntries: ['/settings#media-library-settings'],
      });
      await waitFor(() => {
        expect(screen.getByTestId('media-library-settings-form')).toBeInTheDocument();
      });
